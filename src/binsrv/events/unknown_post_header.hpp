...
#ifndef BINSRV_EVENTS_UNKNOWN_POST_HEADER_HPP
#define BINSRV_EVENTS_UNKNOWN_POST_HEADER_HPP

#include "binsrv/events/unknown_post_header_fwd.hpp" // IWYU pragma: export
...
#endif // BINSRV_EVENTS_UNKNOWN_POST_HEADER_HPP
