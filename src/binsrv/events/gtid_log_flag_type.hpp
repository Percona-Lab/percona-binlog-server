...
#ifndef BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_HPP
#define BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_HPP

#include "binsrv/events/gtid_log_flag_type_fwd.hpp" // IWYU pragma: export
...
// clang-format off
#define BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_SEQUENCE() \
  BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_MACRO(may_have_sbr, 0x01U)
// clang-format on

#define BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_MACRO(X, Y) X = Y
// NOLINTNEXTLINE(readability-enum-initial-value,cert-int09-c)
enum class gtid_log_flag_type : std::uint8_t {
  BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_SEQUENCE(),
  delimiter
};
#undef BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_MACRO
...
#define BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_MACRO(X, Y)                        \
...
#undef BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_XY_SEQUENCE
// NOLINTEND(cppcoreguidelines-macro-usage)

} // namespace binsrv::events

#endif // BINSRV_EVENTS_GTID_LOG_FLAG_TYPE_HPP
