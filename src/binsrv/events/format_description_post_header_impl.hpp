...
#ifndef BINSRV_EVENTS_FORMAT_DESCRIPTION_POST_HEADER_IMPL_HPP
#define BINSRV_EVENTS_FORMAT_DESCRIPTION_POST_HEADER_IMPL_HPP

#include "binsrv/events/format_description_post_header_impl_fwd.hpp" // IWYU pragma: export
