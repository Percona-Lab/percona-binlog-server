...
#ifndef BINSRV_EVENTS_PROTOCOL_TRAITS_HPP
#define BINSRV_EVENTS_PROTOCOL_TRAITS_HPP

#include "binsrv/events/protocol_traits_fwd.hpp" // IWYU pragma: export
...
#endif // BINSRV_EVENTS_PROTOCOL_TRAITS_HPP
