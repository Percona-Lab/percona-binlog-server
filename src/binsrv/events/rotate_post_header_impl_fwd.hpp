...
#ifndef BINSRV_EVENTS_ROTATE_POST_HEADER_IMPL_FWD_HPP
#define BINSRV_EVENTS_ROTATE_POST_HEADER_IMPL_FWD_HPP
...
#endif // BINSRV_EVENTS_ROTATE_POST_HEADER_IMPL_FWD_HPP
