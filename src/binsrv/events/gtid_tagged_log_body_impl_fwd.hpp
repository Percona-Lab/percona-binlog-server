...
#ifndef BINSRV_EVENTS_GTID_TAGGED_LOG_BODY_IMPL_FWD_HPP
#define BINSRV_EVENTS_GTID_TAGGED_LOG_BODY_IMPL_FWD_HPP
...
#endif // BINSRV_EVENTS_GTID_TAGGED_LOG_BODY_IMPL_FWD_HPP
