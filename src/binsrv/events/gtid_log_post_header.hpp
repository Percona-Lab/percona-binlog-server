...
#ifndef BINSRV_EVENTS_GTID_LOG_POST_HEADER_HPP
#define BINSRV_EVENTS_GTID_LOG_POST_HEADER_HPP

#include "binsrv/events/gtid_log_post_header_fwd.hpp" // IWYU pragma: export
...
#endif // BINSRV_EVENTS_GTID_LOG_POST_HEADER_HPP
