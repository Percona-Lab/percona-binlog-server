...
#ifndef BINSRV_EVENTS_GTID_LOG_BODY_HPP
#define BINSRV_EVENTS_GTID_LOG_BODY_HPP

#include "binsrv/events/gtid_log_body_fwd.hpp" // IWYU pragma: export
...
#endif // BINSRV_EVENTS_GTID_LOG_BODY_HPP
