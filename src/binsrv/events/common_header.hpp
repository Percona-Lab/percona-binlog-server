...
#ifndef BINSRV_EVENTS_COMMON_HEADER_HPP
#define BINSRV_EVENTS_COMMON_HEADER_HPP

#include "binsrv/events/common_header_fwd.hpp" // IWYU pragma: export
...
#endif // BINSRV_EVENTS_COMMON_HEADER_HPP
