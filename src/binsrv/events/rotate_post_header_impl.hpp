...
#ifndef BINSRV_EVENTS_ROTATE_POST_HEADER_IMPL_HPP
#define BINSRV_EVENTS_ROTATE_POST_HEADER_IMPL_HPP

#include "binsrv/events/rotate_post_header_impl_fwd.hpp" // IWYU pragma: export
