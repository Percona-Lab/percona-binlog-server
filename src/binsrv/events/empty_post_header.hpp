...
#ifndef BINSRV_EVENTS_EMPTY_POST_HEADER_HPP
#define BINSRV_EVENTS_EMPTY_POST_HEADER_HPP

#include "binsrv/events/empty_post_header_fwd.hpp" // IWYU pragma: export
...
#endif // BINSRV_EVENTS_EMPTY_POST_HEADER_HPP
